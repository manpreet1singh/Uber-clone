  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between' >
           ...
           <form onSubmit={(e)=>{submitHandler(e)}}>
               <h3 className='text-base w-full font-medium mb-2'>Whats your name?</h3>
               ...
               <h3 className='text-base  w-full font-medium mb-2'>Whats your email</h3>
               <input required 
                      value={email}
               ...
               <h3 className='text-base font-medium  mb-2'>Whats your password</h3>
               <input  required 
                       value={password}
